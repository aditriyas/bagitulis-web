        ...
        <div class="d-flex" id="wrapper" data-aos="fade-right">
            ...
            <div class="border-right" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    <a href="{{ url('dashboard') }}" class="list-group-item list-group-item-action">My Writings</a>
                    <a href="{{ url('dashboard/update') }}" class="list-group-item list-group-item-action">Update
                        Writings</a>
                    <a href="{{ url('dashboard/create') }}" class="list-group-item list-group-item-action">Create
                        Writings</a>
                </div>
            </div>
            <!-- /#sidebar-wrapper -->
